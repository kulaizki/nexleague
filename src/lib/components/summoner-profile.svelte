  ...
  <div class="p-6">
    {#if activeTab === 'overview'}
      <div transition:fly={{ y: 10, duration: 200 }}> 
        <h2 class="text-2xl font-bold mb-4 text-emerald-500 [text-shadow:0_0_8px_rgba(0,255,8,0.5)]">Player Analysis</h2>
    ...
    {:else if activeTab === 'matches'}
      <div transition:fly={{ y: 10, duration: 200 }}>
        <h2 class="text-2xl font-bold mb-4 text-emerald-500 [text-shadow:0_0_8px_rgba(0,255,8,0.5)]">Recent Matches</h2>
