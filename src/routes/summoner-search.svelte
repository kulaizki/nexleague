...
<div class="w-full max-w-md mx-auto mt-8 p-6 md:bg-gray-900 rounded-lg md:shadow-lg grid relative"> 
  ...
  >
    ...
    <div class="text-center">
      <button
        type="button"
        on:click={setCreatorProfile}
        class="hover:cursor-pointer text-sm text-emerald-400 hover:text-emerald-300 transition-colors duration-200 focus:outline-none inline-flex items-center"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="orange" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-1.5"><path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4"></path></svg>
        Try with the creator's profile
      </button>
    </div>
  </form>
